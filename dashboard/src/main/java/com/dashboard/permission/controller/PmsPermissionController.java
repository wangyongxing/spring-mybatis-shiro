...
public class PmsPermissionController extends BaseController {
    ...
    @RequestMapping("/list")
    public String listPmsPermission(Page page, PmsPermission pmsPermission, Model model) {
        try {
            List<PmsPermission> list = pmsPermissionService.listPage(page, pmsPermission);
