...
import com.wyx.service.permission.*;
...
public class PmsRoleController extends BaseController {
	...
	@RequestMapping("/list")
	public String listPmsRole(HttpServletRequest req, Page page, PmsRole pmsRole, Model model) {
		try {
			List<PmsRole> list = pmsRoleService.listPage(page, pmsRole);
