 ...
 */
package com.dashboard.permission.controller;

import com.dashboard.controller.common.BaseController;
import com.dashboard.permission.enums.OperatorTypeEnum;
import com.dashboard.permission.utils.PasswordHelper;
import com.dashboard.permission.utils.ValidateUtils;
import com.wyx.common.dwz.DwzAjax;
...
public class PmsOperatorController extends BaseController {
    ...
    @RequestMapping("/list")
    public String listPmsOperator(HttpServletRequest req, Page page, PmsOperator operator, Model model) {
        try {

            List<PmsOperator> list = pmsOperatorService.listPage(page, operator);
